...
public static class AuthServiceCollectionExtensions
{
    ...
    /// <returns>The service collection for chaining.</returns>
    public static IServiceCollection AddOctopusDevAuthWithPat(
        this IServiceCollection services,
        ...
        Action<PersonalAccessTokenAuthenticationOptions>? configurePatOptions = null)
    {
        ...
        services.AddAuthentication(options =>
        {
            options.DefaultAuthenticateScheme = "OctopusAuth";
            options.DefaultChallengeScheme = "OctopusAuth";
        })
        .AddPolicyScheme("OctopusAuth", "Octopus Authentication", options =>
        {
    ...
    /// <param name="configurePatOptions">Optional action to configure PAT auth options.</param>
    /// <returns>The service collection for chaining.</returns>
    public static IServiceCollection AddOctopusOidcAuthWithPat(
        this IServiceCollection services,
        IConfiguration configuration,
        Action<PersonalAccessTokenAuthenticationOptions>? configurePatOptions = null)
    {
