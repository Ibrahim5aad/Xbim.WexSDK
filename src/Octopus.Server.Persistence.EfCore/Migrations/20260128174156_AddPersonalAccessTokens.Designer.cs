...
namespace Octopus.Server.Persistence.EfCore.Migrations
{
    ...
    [Migration("20260128174156_AddPersonalAccessTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Octopus.Server.Domain.Entities.AuthorizationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Octopus.Server.Domain.Entities.OAuthApp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OAuthApps", (string)null);
                });

            modelBuilder.Entity("Octopus.Server.Domain.Entities.OAuthAppAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OAuthAppAuditLogs", (string)null);
                });

            modelBuilder.Entity("Octopus.Server.Domain.Entities.PersonalAccessToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserId", "WorkspaceId", "IsRevoked");

                    b.ToTable("PersonalAccessTokens", (string)null);
                });

            modelBuilder.Entity("Octopus.Server.Domain.Entities.PersonalAccessTokenAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PersonalAccessTokenAuditLogs", (string)null);
                });
            ...
            modelBuilder.Entity("Octopus.Server.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OAuthAppId", "UserId", "IsRevoked");
            ...
            modelBuilder.Entity("Octopus.Server.Domain.Entities.UploadSession", b =>
                {
                    ...
                    b.Property<string>("DirectUploadUrl")
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");
            ...
            modelBuilder.Entity("Octopus.Server.Domain.Entities.AuthorizationCode", b =>
                {
                    b.HasOne("Octopus.Server.Domain.Entities.OAuthApp", "OAuthApp")
                        .WithMany()
            ...
            modelBuilder.Entity("Octopus.Server.Domain.Entities.OAuthApp", b =>
                {
                    b.HasOne("Octopus.Server.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Octopus.Server.Domain.Entities.OAuthAppAuditLog", b =>
                {
                    b.HasOne("Octopus.Server.Domain.Entities.User", "ActorUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Octopus.Server.Domain.Entities.PersonalAccessTokenAuditLog", b =>
                {
                    ...
                    b.HasOne("Octopus.Server.Domain.Entities.PersonalAccessToken", "PersonalAccessToken")
                        .WithMany()
                    ...
                    b.Navigation("PersonalAccessToken");
                });
            ...
            modelBuilder.Entity("Octopus.Server.Domain.Entities.RefreshToken", b =>
                {
                    ...
                    b.HasOne("Octopus.Server.Domain.Entities.RefreshToken", "ParentToken")
                        .WithOne()
                        .HasForeignKey("Octopus.Server.Domain.Entities.RefreshToken", "ParentTokenId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Octopus.Server.Domain.Entities.RefreshToken", "ReplacedByToken")
                        .WithOne()
                        .HasForeignKey("Octopus.Server.Domain.Entities.RefreshToken", "ReplacedByTokenId")
                        .OnDelete(DeleteBehavior.NoAction);
