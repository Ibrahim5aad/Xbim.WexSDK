...
/// <summary>
/// The main database context for the Xbim platform.
/// </summary>
public class XbimDbContext : DbContext
{
    public XbimDbContext(DbContextOptions<XbimDbContext> options)
        : base(options)
    {
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(XbimDbContext).Assembly);
    }
}
