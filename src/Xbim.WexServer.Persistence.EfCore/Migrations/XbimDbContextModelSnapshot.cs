...
namespace Xbim.WexServer.Persistence.EfCore.Migrations
{
    ...
    partial class XbimDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Xbim.WexServer.Domain.Entities.AuthorizationCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Xbim.WexServer.Domain.Entities.OAuthApp", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Xbim.WexServer.Domain.Entities.OAuthAppAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Xbim.WexServer.Domain.Entities.PersonalAccessToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Xbim.WexServer.Domain.Entities.PersonalAccessTokenAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Xbim.WexServer.Domain.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Xbim.WexServer.Domain.Entities.AuthorizationCode", b =>
                {
                    b.HasOne("Xbim.WexServer.Domain.Entities.OAuthApp", "OAuthApp")
                        .WithMany()
            ...
            modelBuilder.Entity("Xbim.WexServer.Domain.Entities.OAuthApp", b =>
                {
                    b.HasOne("Xbim.WexServer.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Xbim.WexServer.Domain.Entities.OAuthAppAuditLog", b =>
                {
                    b.HasOne("Xbim.WexServer.Domain.Entities.User", "ActorUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Xbim.WexServer.Domain.Entities.PersonalAccessTokenAuditLog", b =>
                {
                    ...
                    b.HasOne("Xbim.WexServer.Domain.Entities.PersonalAccessToken", "PersonalAccessToken")
                        .WithMany()
            ...
            modelBuilder.Entity("Xbim.WexServer.Domain.Entities.RefreshToken", b =>
                {
                    ...
                    b.HasOne("Xbim.WexServer.Domain.Entities.RefreshToken", "ParentToken")
                        .WithOne()
                        .HasForeignKey("Xbim.WexServer.Domain.Entities.RefreshToken", "ParentTokenId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Xbim.WexServer.Domain.Entities.RefreshToken", "ReplacedByToken")
                        .WithOne()
                        .HasForeignKey("Xbim.WexServer.Domain.Entities.RefreshToken", "ReplacedByTokenId")
                        .OnDelete(DeleteBehavior.NoAction);
