 ...
 */
export declare class DiscreteHeatmapChannel implements IHeatmapChannel {
     ...
     */
    constructor(channelId: string, dataType: string, name: string, description: string, property: string, unit: string, values: {
        [value: string]: string;
    });
    /**
