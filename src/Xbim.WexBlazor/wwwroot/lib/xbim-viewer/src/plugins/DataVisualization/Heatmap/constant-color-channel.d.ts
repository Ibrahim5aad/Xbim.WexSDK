 ...
 */
export declare class ConstantColorChannel implements IHeatmapChannel {
     ...
     */
    constructor(channelId: string, dataType: string, name: string, description: string, property: string, unit: string, color: string);
    /**
